...
W tym rozdziale przedstawiono g³ówne rozwi¹zania z zakresu in¿ynierii oprogramowania i projektowania, takie jak wymagania funkcjonalne i niefunkcjonalne co do niniejszej pracy oraz diagramy, na których zobrazowano dzia³anie systemu oraz zamieszczono ich opis. Tworz¹c taki projekt systemu, umo¿liwi on zaznajomienie siê z podstawowym dzia³aniem aplikacji. 
...
Na podstawie informacji zebranych z rozdzia³u 1 ,,Przegl¹d istniej¹cych rozwi¹zañ'', jak i wiedzy autora na temat programów graficznych, okreœlone zosta³y podstawowe wymagania dotycz¹ce aplikacji. Podzielono je na wymagania funkcjonalne oraz niefunkcjonalne.

\subsection{Wymagania funkcjonalne}

Aplikacja stworzona w ramach niniejszej pracy powinna spe³niaæ nastêpuj¹ce funkcjonalnoœci:
\begin{itemize}
...
Prócz wymagañ funkcjonalnych zdefiniowano szereg wymagañ niefunkcjonalnych, które aplikacja powinna spe³niaæ. Nale¿¹ do nich:
\begin{itemize}
...
\caption[Diagram stanów dla wczytywania]{Diagram stanów dla wczytywania, Ÿród³o: opracowanie w³asne} 
...
Na rysunku \ref{rys-diagram-przypadkow-uzycia} przedstawiono diagram przypadków u¿ycia, w którym zawarte s¹ wszystkie najwa¿niejsze wymagania funkcjonalne w formie graficznej. 

\begin{figure}[htb]
\centering
\includegraphics[width=1\textwidth, keepaspectratio]{grafika/diagram-przypadkow-uzycia.png}
\caption[Diagram przypadków u¿ycia]{Diagram przypadków u¿ycia, Ÿród³o: opracowanie w³asne} 
