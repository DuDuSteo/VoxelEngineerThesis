...
\caption[Ekran startowy programu]{Ekran startowy programu, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno zmiany ustawieñ sceny]{Okno zmiany ustawieñ sceny, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno zmiany bie¿¹cego materia³u, jak i jego edycji]{Okno zmiany bie¿¹cego materia³u, jak i jego edycji, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno wyboru wartoœci koloru wraz z podgl¹dem po prawej stronie]{Okno wyboru wartoœci koloru wraz z podgl¹dem po prawej stronie, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno z informacjami o dzia³aniu silnika graficznego]{Okno z informacjami o dzia³aniu silnika graficznego, Ÿród³o: opracowanie w³asne} 
...
\caption[Pasek nawigacyjny z wybran¹ opcj¹ ,,Window'']{Pasek nawigacyjny z wybran¹ opcj¹ ,,Window'', Ÿród³o: opracowanie w³asne} 
...
\caption[Okno ,,Material'' ze zmienionym rozmiarem przez u¿ytkownika]{Okno ,,Material'' ze zmienionym rozmiarem przez u¿ytkownika, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno ,,Material'' w wersji zminimalizowanej]{Okno ,,Material'' w wersji zminimalizowanej, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno trybu edycji modelu 3D]{Okno trybu edycji modelu 3D, Ÿród³o: opracowanie w³asne} 
...
\caption[Pasek nawigacyjny z wybran¹ opcj¹ ,,File'']{Pasek nawigacyjny z wybran¹ opcj¹ ,,File'', Ÿród³o: opracowanie w³asne} 
...
\caption[Okno wczytania modeli do edytora]{Okno wczytania modeli do edytora, Ÿród³o: opracowanie w³asne} 
...
\caption[Okno zapisu aktualnego modelu 3D do pliku]{Okno zapisu aktualnego modelu 3D do pliku, Ÿród³o: opracowanie w³asne} 
...
\caption[Konsola aplikacji]{Konsola aplikacji, Ÿród³o: opracowanie w³asne} 
...
\caption[Edytor modeli po uruchomieniu wraz z konsol¹]{Edytor modeli po uruchomieniu wraz z konsol¹, Ÿród³o: opracowanie w³asne} 
...
\caption[Wybór okna ,,Material'' z paska narzêdziowego]{Wybór okna ,,Material'' z paska narzêdziowego, Ÿród³o: opracowanie w³asne}
...
\caption[Prezentacja w³aœciwoœci materia³u w oknie ,,Material'']{Prezentacja w³aœciwoœci materia³u w oknie ,,Material'', Ÿród³o: opracowanie w³asne}
...
\caption[Okno wyboru koloru z kwadratu kolorów]{Okno wyboru koloru z kwadratu kolorów, Ÿród³o: opracowanie w³asne}
...
\caption[Klikniêcie na wybran¹ œciankê]{Klikniêcie na wybran¹ œciankê, Ÿród³o: opracowanie w³asne}
...
\caption[Wynik interakcji z opcj¹ ,,Add'']{Wynik interakcji z opcj¹ ,,Add'', Ÿród³o: opracowanie w³asne}
...
\caption[Klikniêcie na wybranego woksela w celu usuniêcia]{Klikniêcie na wybranego woksela w celu usuniêcia, Ÿród³o: opracowanie w³asne}
...
\caption[Wynik interakcji z opcj¹ ,,Remove'']{Wynik interakcji z opcj¹ ,,Remove'', Ÿród³o: opracowanie w³asne}
...
\caption[Klikniêcie na wybranego woksela w celu zmiany materia³u]{Klikniêcie na wybranego woksela w celu zmiany materia³u, Ÿród³o: opracowanie w³asne}
\label{rys-inst-color}
\vspace{0.5cm}
\includegraphics[width=0.6\textwidth, keepaspectratio]{grafika/inst-colored.png}
\caption[Wynik interakcji z opcj¹ ,,Color'']{Wynik interakcji z opcj¹ ,,Color'', Ÿród³o: opracowanie w³asne}
...
\caption[Wybór okna ,,Scene'' z paska narzêdziowego]{Wybór okna ,,Scene'' z paska narzêdziowego, Ÿród³o: opracowanie w³asne}
...
\caption[Przyk³ad praworêcznego systemu uk³adu wspó³rzêdnych]{Przyk³ad praworêcznego systemu uk³adu wspó³rzêdnych, Ÿród³o: \cite{learn_opengl}}
...
\caption[Przyk³adowe ustawienia oœwietlenia przy u¿yciu okna ,,Scene'']{Przyk³adowe ustawienia oœwietlenia przy u¿yciu okna ,,Scene'', Ÿród³o: opracowanie w³asne}
...
\caption[Okno wyboru nazwy pliku do zapisu]{Okno wyboru nazwy pliku do zapisu, Ÿród³o: opracowanie w³asne}
...
\caption[Okno wyboru œcie¿ki pliku do odczytu]{Okno wyboru œcie¿ki pliku do odczytu, Ÿród³o: opracowanie w³asne}
\label{rys-inst-load}
\end{figure}
...
\caption[Przycisk stworzenia nowego modelu 3D w pasku narzêdziowym]{Przycisk stworzenia nowego modelu 3D w pasku narzêdziowym, Ÿród³o: opracowanie w³asne}
\label{rys-inst-new}
\end{figure}
